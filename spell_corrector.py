from tkinter import *                                           #tkinter is a standard GUI library used to create basic GUI
from textblob import TextBlob                                   #TextBlob is a Python library for processing textual data.

def clearAll():													# Function to clear both the text entry boxes

	# whole content of text entry area is deleted
	word1_field.delete(0, END)
	word2_field.delete(0, END)

def correction():												# Function to get a corrected word
